...
/**
 * Conteúdo da gestão de Field Staff (Staff de Campo).
 * Usado em /operacao/staff e como tab dentro de /operacao/equipa.
 */
export function FieldStaffSection({ compact = false }: { compact?: boolean }) {
      ...
      <div className="flex items-center justify-between">
        {compact ? (
          <p className="text-sm text-muted-foreground">
            Produtores e auxiliares com login restrito à Operação.
          </p>
        ) : (
          <div>
