...
// Vive em /audience/google-ads. Leitura das tabelas crm.google_* + sync via
// edge function crm-google-ads-sync. Espelha o estilo do Dashboard Meta Live
// (toggle de plataforma, cards KPI, tabela com drill-down). Inclui também um
// bloco compacto de "Definições" (OAuth / dev token / conversion actions).
// RBAC: AudienceLayout já gateia admin / platform_admin / marketing_manager;
// reforçamos o check interno como o GoogleAdsAdmin antigo fazia.
...
export default function GoogleAdsDashboard() {
  ...
  // RBAC — espelha o que o AudienceLayout já faz, mas explícito.
  ...
  return (
    <div className="space-y-6">
      {/* Toggle plataforma (Meta ↔ Google) — navegação SPA via Link */}
      ...
      {/* Definições — bloco compacto (sem tab) */}
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-2 text-sm">
          <p className="text-muted-foreground">
            Ligação da conta Google Ads (OAuth), developer token, conversion actions e mapeamento de eventos.
          </p>
          <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
            <li>Conexão OAuth (<code className="text-xs bg-muted px-1 rounded">crm.ad_platform_connections</code>, platform=&apos;google&apos;).</li>
            <li>Conversion actions e mapeamento order → conversão.</li>
            <li>Estado do developer token (Basic/Standard).</li>
          </ul>
        </CardContent>
      </Card>
