select net.http_post(
  ...
  body := jsonb_build_object('action','matrix','configId','12e8fa47-d4f7-4d89-92ff-f41ac6133c84','urls', jsonb_build_array(
    ...
    'https://manager.ticketline.pt/managers/events/68027/sale_summary.xlsx?granularity=2',
    'https://manager.ticketline.pt/managers/events/68027/sale_summary.xlsx?granularity=0'
  )),
