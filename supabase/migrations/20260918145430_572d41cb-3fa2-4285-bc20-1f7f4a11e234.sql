...
comment on function public.check_ticketing_sync_health() is
  'Saúde do sync de bilheteira (Ticketline/BOL) para eventos futuros: (a) 3 corridas seguidas sem sucesso, (b) sem sucesso há >6h, (c) config desligada (só banner), (d) capture_day sem sucesso há >3h. Escreve system_reminders (key ticketing_sync_stalled) e só depois envia email (a/b/d), com anti-spam de 12h em sync_notifications_sent.';
