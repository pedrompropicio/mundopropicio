...
BEGIN
  ...
  IF v_check_bp_line THEN
    ...
    --
    -- Sexta isencao (20/09/2026, #111): rubrica 10.3 "Transferencias Internas"
    -- (ou descendente). Sao movimentos de tesouraria/bilheteira; o BP nunca tem
    -- linha para eles, com ou sem evento. Em Live havia 17 transacoes
    -- aprovadas/pagas em 10.3 com evento que ficavam "sem linha" por definicao.
    IF NEW.type = 'expense'
