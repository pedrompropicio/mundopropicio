-- Restore migration — repõe portal_tick_lead_capture e portal_tick_redirect_log
-- na versão D1 (POST directo a graph.facebook.com via vault token), corrigindo
-- a regressão introduzida pela migration 20260604120000 que continha a versão V0.
-- Definições D1 extraídas directamente de Live (sfohvvlqccmmebvjgibx) em 05/06/26.
