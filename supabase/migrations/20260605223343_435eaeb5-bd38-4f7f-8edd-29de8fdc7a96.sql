-- ============================================================
-- Migration 1: recover_process_batch_helpers (20260605100000)
-- ============================================================
...
-- ============================================================
-- Migration 2: portal_cron_inline_dispatch (20260604120000)
-- ============================================================
...
BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'unschedule portal-process-lead-capture failed: %', SQLERRM;
END $$;
...
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'schedule portal-process-lead-capture failed: %', SQLERRM;
END $$;
...
BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'unschedule portal-process-redirect-log failed: %', SQLERRM;
END $$;
...
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'schedule portal-process-redirect-log failed: %', SQLERRM;
END $$;