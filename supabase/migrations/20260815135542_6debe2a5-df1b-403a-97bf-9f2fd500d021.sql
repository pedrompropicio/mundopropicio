select net.http_post(
  ...
  body := jsonb_build_object('action','matrix','configId','12e8fa47-d4f7-4d89-92ff-f41ac6133c84','urls', jsonb_build_array(
    ...
    'https://manager.ticketline.pt/managers/dashboard/sale_summary.xlsx?granularity=2&event_ids=68027&start_date=2026-01-01&end_date=2026-08-15',
    'https://manager.ticketline.pt/managers/dashboard/sale_summary.xlsx?granularity=2&bulk_event_ids=68027&filter%5Bstart_date%5D=01-01-2026&filter%5Bend_date%5D=15-08-2026',
    'https://manager.ticketline.pt/managers/dashboard/sale_summary?granularity=2&bulk_event_ids=68027&filter_start_date=01-01-2026&filter_end_date=15-08-2026'
  )),
