...
ALTER TABLE public.bp_version_audit_log ADD CONSTRAINT bp_version_audit_log_action_check CHECK (action = ANY (ARRAY[
  'created'::text,
  ...
  'scenario_promoted_to_active'::text,
  'scenario_promoted_to_active_cascade'::text,
  'pinned'::text,
  'unpinned'::text,
  'reverted'::text,
  'reconciled'::text,
