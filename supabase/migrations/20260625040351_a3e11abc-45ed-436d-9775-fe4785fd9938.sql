...
CREATE OR REPLACE FUNCTION public.crm_meta_capi_dashboard(p_days integer DEFAULT 7)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
    ...
    'events_pixel_status', (
      ...
      FROM (
        SELECT jsonb_build_object(
          ...
          'meta_audience_id', e.meta_audience_id,
          'meta_audience_name', e.meta_audience_name,
          'leads_period', (
