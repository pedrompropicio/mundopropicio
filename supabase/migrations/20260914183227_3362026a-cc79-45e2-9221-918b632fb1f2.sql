...
VALUES (
  'grupo_fatura_veredicto_desagrupar_por_aplicar',
  'Grupos de fatura com veredicto OCR "desagrupar" ainda não aplicado e transações ainda agrupadas',
  'error',
  'global',
  0,
  'Semeada a 14/09/2026 com contagem real 0. Valor > 0 = a revalidação por OCR acertou e ficou à espera de um clique que ninguem deu.'
)
