-- DR-2026-06-27d — RPC para escolha do vencedor do duelo
-- Marca um candidato como 'selected' e o irmão como 'archived', com validação de ownership.
...
BEGIN
  ...
  -- Confirma que existe pelo menos um irmão no mesmo duelo e na mesma company
  ...
  IF v_sibling_count < 1 THEN
    RAISE EXCEPTION 'sibling_missing';
  END IF;
